...
class FlxSplash extends FlxState
{
	...
	override public function create():Void
	{
		...
		if (!muted)
		{
			FlxG.sound.play('assets/sounds/flixel.mp3', 0.7);
		}
		#end
		if (FlxG.save.data.hasSeenSplash != null && FlxG.save.data.hasSeenSplash)
		{
			...
			skipScreen.setFormat("Nokia Cellphone FC Small", 18, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
